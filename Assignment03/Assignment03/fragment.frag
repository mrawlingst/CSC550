...
void main(void)
{
	...
	vec4 color = vec4(0.0);
	color.rgb += lightColor1 * light1Diffuse * light1Specular;
	color.rgb += lightColor2 * light2Diffuse * light2Specular;
	color.rgb += lightColor3 * light3Diffuse * light3Specular;
